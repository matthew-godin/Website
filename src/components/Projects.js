    ...
    return (
        <>
            ...
            <div style={{minHeight: '6vh', maxHeight: '6vh', position: 'relative', width: '100%', display: responsiveStyles.sectionsMobileSite}}>
                <div style={{ paddingBottom: '2%', position: 'absolute', top: 0, width: '100%'}}>
                    <Row style={projectLineStyle}>
                        <Col style={projectTitleWeight} xs={12}><Link to='https://github.com/matthew-godin/Licode' style={{textDecoration: 'none', color: 'black'}}>Licode</Link></Col>
                        <Col xs={4}></Col>
            ...
            <div style={{minHeight: '7vh', maxHeight: '7vh', position: 'relative', width: '100%', display: responsiveStyles.sectionsMobileSite}}>
                <div style={{ paddingBottom: '2%', position: 'absolute', top: 0, width: '100%'}}>
                    <Row style={projectSecondLineStyle}>
                        ...
                        <Col xs={8} style={{textAlign: 'right', fontSize: '20px', fontWeight: projectSkillsWeight}}>TypeScript • Deno • React • Go • Python • Docker • SQL</Col>
                    </Row>
                </div>
            </div>
            <div style={{minHeight: '6vh', maxHeight: '6vh', position: 'relative', width: '100%', display: responsiveStyles.sectionsMobileSite}}>
            ...
            <div style={{minHeight: '6vh', maxHeight: '6vh', position: 'relative', width: '100%', display: responsiveStyles.sectionsMobileSite}}>
                <div style={{ paddingBottom: '2%', position: 'absolute', top: 0, width: '100%'}}>
                    <Row style={projectLineStyle}>
                        <Col style={projectTitleWeight} xs={12}><Link to='https://github.com/matthew-godin/Once-Upon-a-Time' style={{textDecoration: 'none', color: 'black'}}>Once Upon a Time</Link></Col>
                        <Col xs={4}></Col>
            ...
            <div style={{minHeight: '7vh', maxHeight: '7vh', position: 'relative', width: '100%', display: responsiveStyles.sectionsMobileSite}}>
                <div style={{ paddingBottom: '2%', position: 'absolute', top: 0, width: '100%'}}>
                    <Row style={projectSecondLineStyle}>
                        <Col style={jobDescriptionStyle} xs={21}>Google Chrome plugin that allows writing mathematical expressions in Facebook Messenger (first place, MHacks Nano 2017)</Col>
