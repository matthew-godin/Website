        ...
        <>
            <div style={{ margin: '0', width: '100%', minHeight: '90vh', position: 'relative', backgroundColor: '#242424'}}>
                <div style={responsiveStyles.headerContainerContainer}>
                    <div style={responsiveStyles.headerContainer}>
                        ...
                        <span>
                            ...
                            <span style={responsiveStyles.linksSvgSection}>
                                <span style={responsiveStyles.linksSvgSpan}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width={responsiveStyles.linksSvgSize} height={responsiveStyles.linksSvgSize} viewBox="0 0 24 24">
                    ...
                    <Chevron color="white" marginTop={responsiveStyles.headerChevronMarginTop} link={responsiveStyles.headerLink} size={responsiveStyles.chevronSize} />
                </div>
            </div>
